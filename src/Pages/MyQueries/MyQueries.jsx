...
const MyQueries = () => {
  ...
  return (
    <section className={`${responsive} mt-10`}>
      <div>
        <div className="flex flex-col gap-3 md:gap-0 md:flex-row justify-between items-center py-8 px-5 bg-primary dark:bg-gray-900 rounded-2xl">
          <Title
            className={"text-white dark:text-gray-100 text-xl md:text-2xl"}
            title={`All Product Queries (${myQueries.length}) `}
          />
          <div className="flex flex-col md:flex-row items-center gap-3 ">
            {/* Search Fuction */}
            <label className="input w-70 ring-0 focus-within:ring-0 focus-within:ring-primary focus-within:outline-none dark:bg-gray-800 dark:border-gray-700">
              <div className="opacity-50 text-gray-300 dark:text-gray-400">
                <IoIosSearch size={20} />
              </div>
              <input
                className="grow bg-white dark:bg-gray-800 dark:text-gray-100 focus:outline-none focus:border-transparent"
                type="search"
                name="search"
            ...
            <Link
              className="btn bg-white dark:bg-gray-700 dark:text-gray-100 text-primary px-8"
              to={"/addquery"}
            >
              <FaPlus />
              Add New Query
